...
data "aws_ssm_parameter" "db_pass" {
  name = data.terraform_remote_state.postgres_setup.outputs.strapi_db_pass_ssm_key
}
...
locals {
  ...
  db_name             = data.terraform_remote_state.postgres_setup.outputs.strapi_db_name
